...
!     memoryperomega is the quantity of memory used for one omega step.
  ...
  if ((rmax-r0) < shallowdepth) then
    ...
    do i = 1, ndc + 1
      call calmatc(nlayerinzone(i), vnp, vra, rho, 2, 0, 0, radii(isp(i)), t(jsp(i)), work(jsp(i)))
      call calmatc(nlayerinzone(i), vnp, vra, ecL, 2, 1, 1, radii(isp(i)), h1(jsp(i)), work(jsp(i)))
      call calmatc(nlayerinzone(i), vnp, vra, ecL, 1, 1, 0, radii(isp(i)), h2(jsp(i)), work(jsp(i)))
      call calmatc(nlayerinzone(i), vnp, vra, ecL, 0, 0, 0, radii(isp(i)), h3(jsp(i)), work(jsp(i)))
      call calmatc(nlayerinzone(i), vnp, vra, ecN, 0, 0, 0, radii(isp(i)), h4(jsp(i)), work(jsp(i)))
      call caltl(nlayerinzone(i), vnp, vra, rho, radii(isp(i)), work(jsp(i)))
      call calt(nlayerinzone(i), t(jsp(i)), work(jsp(i)), t(jsp(i)))
      call calhl(nlayerinzone(i), vnp, vra, ecL, radii(isp(i)), work(jsp(i)))
      call calt(nlayerinzone(i), h3(jsp(i)), work(jsp(i)), h3(jsp(i)))
      call calhl(nlayerinzone(i), vnp, vra, ecN, radii(isp(i)), work(jsp(i)))
      call calt(nlayerinzone(i), h4(jsp(i)), work(jsp(i)), h4(jsp(i)))
    end do
