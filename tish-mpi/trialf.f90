...
! For each receiver, this subroutine must be called for each l-value in order, since results from previous l-values are referenced.
!------------------------------------------------------------------------
...
!------------------------------------------------------------------------
  ...
  !:::::::::::::::::::::::::::::::::::::::: Values for previous l's must be provided. The value for this l will be placed in plm(1,m).
  !:::::::::::::::::::::::::::::::::::::::: Arguments: previous l's (1 before : 3 before), m (0:3).
  complex(8), intent(out) :: trialFunctionValues(3, -2:2)  ! Values of trial function, computed for each l and receiver.
