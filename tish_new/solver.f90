...
! For the first time using a matrix A, this must be called from the beginning to conduct Cholesky decomposition.
! In subsequent callings, the decomposition can be skipped.
!------------------------------------------------------------------------
subroutine solveWholeCFromStart(a, n, nud, n1, b, eps, dr, z, ier)
!------------------------------------------------------------------------
  implicit none
  ...
  call decompose(a, n, nud, n1, eps, dr, ier)
  if (ier /= 0) return

!------------------------------------------------------------------------
! When skipping decomposition, call from this entry point.
!------------------------------------------------------------------------
 entry solveWholeCFromMiddle(a, n, nud, n1, b, eps, dr, z, ier)
!------------------------------------------------------------------------
...
! In subsequent callings, the decomposition can be skipped.
!------------------------------------------------------------------------
subroutine solveC0FromStart(a, n, nud, n1, np, b, eps, dr, z, ier)
!------------------------------------------------------------------------
  implicit none
...
! When skipping decomposition, call from this entry point.
!------------------------------------------------------------------------
 entry solveC0FromMiddle(a, n, nud, n1, np, b, eps, dr, z, ier)
!------------------------------------------------------------------------
...
!------------------------------------------------------------------------
! Decomposees matrix A.
!------------------------------------------------------------------------
subroutine decompose(a, n, nud, n1, eps, dr, ier)
!------------------------------------------------------------------------
  implicit none
