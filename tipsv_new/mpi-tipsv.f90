...
program tipsv
  ...
  ! share input values
  call MPI_BCAST(vpvPolynomials, 4 * maxNZone, MPI_DOUBLE_PRECISION, 0, MPI_COMM_WORLD, ierr)   !!!diff from non-mpi
  call MPI_BCAST(vphPolynomials, 4 * maxNZone, MPI_DOUBLE_PRECISION, 0, MPI_COMM_WORLD, ierr)
  call MPI_BCAST(etaPolynomials, 4 * maxNZone, MPI_DOUBLE_PRECISION, 0, MPI_COMM_WORLD, ierr)
  call MPI_BCAST(qkappaOfZone, maxNZone, MPI_DOUBLE_PRECISION, 0, MPI_COMM_WORLD, ierr)
  ! (The following are same as tish.)
